 ...
 * in I/O threads.</p>
 *
 * <p>{@link #stored(net.ihiroky.niotty.StageContext, Object)} or
 * {@link #loaded(net.ihiroky.niotty.StageContext, Object)} form a call chain,
 * this is controlled by each {@code Stage}. The first stage is triggered
 * by {@link net.ihiroky.niotty.Pipeline}, and if {@link net.ihiroky.niotty.StageContext#proceed(Object)}
 ...
 * There is no need to call {@link net.ihiroky.niotty.StageContext#proceed(Object)} for these methods.</p>
 *
